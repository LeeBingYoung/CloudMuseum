 ...
 */
@Controller
public class HomeArtController {
    @Resource
    ...
    @RequestMapping("/HomeArtLogin")
    public String homeArtLogin(@RequestParam("username") String username, @RequestParam("password") String password, HttpServletRequest request, HttpServletResponse response,Model model){
    ...
    @RequestMapping("/HomeArtRegister")
    public String homeArtRegister(@RequestParam("username") String username,@RequestParam("password") String password,@RequestParam("mail") String mail,Model model,HttpServletRequest request,HttpServletResponse response){
        userService.selectPasswordByID(username);
        //注册
    ...
    @RequestMapping("/HomeArt")
    public String homeArt(Model model, HttpServletRequest request){
        //展示全部艺术品
        List<ArtWork> homeArtWorkList = artWorkService.getArtWorkAll();
