...
public class HomeStoryController {
    ...
    @RequestMapping("/HomeStoLogin")
    public String homeStoLogin(@RequestParam("username") String username, @RequestParam("password") String password, HttpServletRequest request, HttpServletResponse response,Model model){
    ...
    @RequestMapping("/HomeStoRegister")
    public String homeStoRegister(@RequestParam("username") String username,@RequestParam("password") String password,@RequestParam("mail") String mail,Model model,HttpServletRequest request,HttpServletResponse response){
        userService.selectPasswordByID(username);
        //注册
    ...
    @RequestMapping("/HomeStory")
    public String homeArtStory(Model model, HttpServletRequest request){
        //展示全部艺术故事
        List<ArtStory> homeArtStoryList = artStoryService.getArtStoryAll();
        model.addAttribute("ArtStoryAll",homeArtStoryList);
        return "HomeStory";
    }
}
